        ...
        try {
            ...
            switch (method) {
                ...
                case ASSET_LIST:
                    ...
                    Asset asset2 = getBasicAsset();
                    listAssetResponse.getAsset().add(asset2);
                    String listResponse = AssetModuleResponseMapper.mapAssetModuleResponse(listAssetResponse);
                    messageProducer.sendModuleResponseMessage(textMessage, listResponse);
                    break;
                default:
                    break;
            }
